...
export function mapProjectRow(
  ...
  return normalizeProjectTopics({
    ...
    miniatureAltPl: project.miniature_alt_pl ?? "",
    miniatureAltEn: project.miniature_alt_en ?? "",
    technologies,
    miniaturePath,
    miniatureUrl,
    topics,
...
export function mapProjectToRow(project: Project, displayOrder: number) {
  return {
    ...
    miniature_alt_pl: project.miniatureAltPl,
    miniature_alt_en: project.miniatureAltEn,
